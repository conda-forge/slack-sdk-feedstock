...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/slack-sdk-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/slack-sdk-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add slack-sdk slack_sdk
# for installing globally
pixi global install slack-sdk slack_sdk
```
...
It is possible to list all of the versions of `slack-sdk` available on your platform:
...
```
pixi search slack-sdk --channel conda-forge
```
